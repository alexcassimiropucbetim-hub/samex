...
import { Home, MapPin, Church, ListMusic, Music, Music2, Users, UserCheck, ChevronDown, FolderOpen, Briefcase, FileSignature, CalendarClock, LogOut, Settings, Menu, X, Activity, UserCog, BookOpen, BellRing } from "lucide-react";
  ...
  return (
    <>
      ...
      <aside className={clsx(
        "w-64 h-screen flex flex-col fixed left-0 top-0 border-r border-slate-800 bg-slate-900 z-50 overflow-y-auto transition-transform duration-300",
            ...
            return (
              <div key={group.name} className="flex flex-col">
                <button 
                  ...
                  className="flex items-center justify-between px-2 py-2 text-slate-400 hover:text-white transition-colors group mb-2"
                >
        ...
        <div className="p-4 border-t border-slate-800 text-center text-xs text-slate-500 sticky bottom-0 bg-slate-900/95 backdrop-blur-md">
