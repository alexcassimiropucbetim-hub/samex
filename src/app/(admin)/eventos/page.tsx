                  ...
                  {isEditing ? (
                    <form action={async (formData: FormData) => {
                      ...
                      <div className="flex flex-col md:flex-row gap-4 w-full">
                        ...
                        <div className="flex items-start justify-end gap-2 shrink-0 mt-2 md:mt-0">
                          ...
                          <Link href="/eventos" className="text-slate-400 hover:text-slate-600 p-2 rounded-lg hover:bg-slate-100 transition-colors" title="Cancelar">
                            <X className="w-5 h-5" />
                          </Link>
                        </div>
                      </div>
                    ...
                    <>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <Link href={`/eventos?edit=${event.id}`} className="text-slate-400 hover:text-blue-500 p-2 rounded-lg hover:bg-blue-50 transition-colors" title="Editar Evento">
