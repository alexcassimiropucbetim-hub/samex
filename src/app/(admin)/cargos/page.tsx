        ...
        <div className="lg:col-span-3 space-y-4 overflow-hidden">
          ...
          {cargos.length > 0 && (
            <div className="lg:hidden flex flex-col gap-4 mt-4">
              {cargos.map((cargo) => (
                <div key={cargo.id} className="bg-white rounded-xl p-4 shadow-sm border border-slate-200 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Link 
                      href={`/cargos?edit=${cargo.id}`}
                      className="text-slate-500 hover:text-indigo-400 p-2.5 rounded-xl hover:bg-indigo-400/10 transition-colors"
                      title="Editar Cargo"
                    >
                      <Pencil className="w-4 h-4" />
                    </Link>
