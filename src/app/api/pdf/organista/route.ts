...
import { generateOrganistaLetter } from "@/lib/pdfGenerator";
  ...
  try {
    ...
    return new Response(pdfBytesModified as any, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="Pedido_Organista_${preEvaluation.candidateName.replace(/\s+/g, '_')}.pdf"`,
      },
    });
